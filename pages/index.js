      ...
      <main className='max-w-7xl mx-auto px-8 sm:px-16'>
        <section className='pt-6'>
          ...
          <div className='grid gird-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
            {exploreData?.map(({ img, distance, location }, key ) => <SmallCard key={key} img={img} distance={distance} location={location} /> )}
          </div>
        </section>
        <section>
        ...
        <LargeCard img='https://links.papareact.com/4cj' title='The Greatest Outdoors' description='A Description' buttonText='Get Inspired' />
      </main>
    </div>
  )
}
